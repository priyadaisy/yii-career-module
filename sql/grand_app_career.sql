...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2015 at 04:09 PM
...
INSERT INTO `job_application` (`id`, `job_id`, `name`, `email`, `mobile`, `url_github`, `url_behance`, `description`, `resume_path`, `remark`, `status`, `applied_on`) VALUES
(1, 2, 'hkjhkjh', 'kjhkjh@kjlk.jhfgjg', 45654654, 'kfjdghkdhf', 'jfhjkdfh', '<p>fghfg h</p>', 'fjh lkg', '', 0, '0000-00-00 00:00:00'),
(2, 2, 'aora', 'dfklg', 454654, '', '', '<p>ghkj</p>', 'fgh', '', 1, '0000-00-00 00:00:00'),
(3, 1, 'nirmanyu', 'jfhg@f.ljkdfjh', 354654654, 'fghkljflkj', 'kjbfjklh', '<p>sfkjhfklgj</p>', 'fklhlkfghl', '', 1, '0000-00-00 00:00:00'),
(4, 1, 'nirmanyu', 'nirmanyiu03@gmakdh.dfgkjh', 87874465, 'kdfjh', 'dfh', '<p>dfg fgh jgfjh</p><p>&nbsp;h</p><p>fgh fg</p><p>&nbsp;</p>', 'dfg fg df', '', 1, '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `job_description` (
  ...
  `update_on` varchar(50) CHARACTER SET utf8 NOT NULL
...
INSERT INTO `job_description` (`id`, `job_title`, `job_kind`, `job_category`, `job_description_details`, `status`, `update_on`) VALUES
(1, 'title', 'freelance-or-consulting', 'mobile', 'description', 1, '1439874964'),
...
(7, 'hello', 'short-term-contract', 'interaction-design', '<p>jsdhfkj hksjdhf kjsdha</p>', 1, '1439893577'),
(9, 'hello123', 'short-term-contract', 'interaction-design', '<p>sdkfjsad jfljs dlkj</p>', 0, '1439894259');
