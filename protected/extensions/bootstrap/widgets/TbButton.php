...
class TbButton extends CWidget
{
	...
	/**
	 * @var string the button icon placement, e.g 'before','after'
	 * Added by Napoleon
	 */
	...
	*/
	...
	public function init()
	{
		...
		if (isset($this->icon))
		{
			...
			//Tweak: to have iconplacement before or after the text ,
			//Added by Napoleon
			if (!isset($this->iconplacement)){
				$this->iconplacement = 'before';
			}

			//Tweak: Added by Napoleon
			if($this->iconplacement == 'before') {
					$this->label = '<i class="'.$this->icon.'"></i>   '.$this->label;
			} elseif ($this->iconplacement == 'after' ){
