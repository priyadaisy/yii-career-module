...
class JobApplicationController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('JobApplication');
	 ...
	 * @param JobApplication $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='job-application-form')
		{
